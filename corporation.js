import { getResetInfo, log } from './helpers.js'
...
const round1Money = 440e9
const round2Money = 8.8e12
const round3Money = 12e15
const round4Money = 500e18 
...
export async function main(ns) {
  ...
  const myBN = (await getResetInfo(ns)).currentNode;
...
function updateHud(ns) {
  ...
  for (const div of industries) {
    ...
    if (indDataDB[hasDivDB[div].industry] === undefined)
      indDataDB[hasDivDB[div].industry ] = c.getIndustryData(division.industry )
      ...
      for (const product of division.products) {
        ...
        if (prog === 100) {
          if (sellPrice === 0) ns.printf("  Calculating - %s", product)
            ...
            ns.printf("  $%s - %s", ns.format.number(getSellPrice(ns, div, "Sector-12", product), 3), product)
          }
        }
        else {
...
function setJob(ns, div, city, job, total) {
  ns.corporation.setJobAssignment(div, city, job, total);
}
          ...
          switch (round) {
            case 1:
              ...
              if (c.getDivision(div).researchPoints < 60)
                setJob(ns, div, city, "Research & Development", c.getOffice(div, city).numEmployees)
              else {
                setJob(ns, div, city, "Operations", 1)
                setJob(ns, div, city, "Engineer", 1)
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Management", 1)
              }
              break
            case 2:
              ...
              if (c.getDivision(div).researchPoints < 700)
                ...
                setJob(ns, div, city, "Operations", Math.floor(c.getOffice(div, city).numEmployees / 2.66))
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 4))
                setJob(ns, div, city, "Business", 1)
                ...
                setJob(ns, div, city, "Management", remainder)
              }
              break
            case 3:
              while (c.getOffice(div, city).numEmployees < c.getOffice(div, city).size && c.hireEmployee(div, city)) { }
              ...
              {
                setJob(ns, div, city, "Operations", 1)
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 3))
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 4))
                ...
                setJob(ns, div, city, "Research & Development", left)
              }
              if (!hasDiv3) break
            ...
            case 4:
              ...
              {
                setJob(ns, div, city, "Operations", 1)
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 2))
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 4))
            ...
            case 5:
              ...
              resetOffice(ns, div, city)
              {
                setJob(ns, div, city, "Operations", 1)
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 2.5))
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 2.5))
        ...
        case "Chemical":
          switch (round) {
            ...
            case 3:
              ...
              resetOffice(ns, div, city)
              {
                setJob(ns, div, city, "Operations", Math.max(1, Math.floor(c.getOffice(div, city).numEmployees / 4)))
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 4))
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 4))
            ...
            case 4:
              ...
              resetOffice(ns, div, city)
              {
                setJob(ns, div, city, "Operations", Math.floor(c.getOffice(div, city).numEmployees / 4))
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 4))
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 4))
            ...
            case 5:
              ...
              resetOffice(ns, div, city)
              {
                ...
                setJob(ns, div, city, "Business", 1)
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 3))
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 3))
                const office = c.getOffice(div, city)
          ...
          switch (round) {
            case 3: {
              ...
              if (city !== "Sector-12" && !tobaccoBooster)
                ...
                setJob(ns, div, city, "Operations", Math.floor(c.getOffice(div, city).numEmployees / 3))
                setJob(ns, div, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 3))
                setJob(ns, div, city, "Business", 1)
                const office = c.getOffice(div, city)
                ...
                setJob(ns, div, city, "Management", left)
              }
              if (!hasDiv3) break
          ...
          switch (round) {
            case 5:
              ...
              resetOffice(ns, div, city)
              {
                setJob(ns, div, city, "Operations", Math.floor(c.getOffice(div, city).numEmployees / 4))
                setJob(ns, div, city, "Business", 1)
                setJob(ns, iv, city, "Engineer", Math.floor(c.getOffice(div, city).numEmployees / 3))
                setJob(ns, div, city, "Management", Math.floor(c.getOffice(div, city).numEmployees / 3))
                const office = c.getOffice(div, city)
                const left = office.numEmployees - Math.floor(c.getOffice(div, city).numEmployees / 3) - Math.floor(c.getOffice(div, city).numEmployees / 3) - Math.floor(c.getOffice(div, city).numEmployees / 4) - 1
                setJob(ns, div, city, "Research & Development", left)
...
function resetOffice(ns, div, city) {
  setJob(ns, div, city, "Operations", 0)
  setJob(ns, div, city, "Engineer", 0)
  setJob(ns, div, city, "Business", 0)
  setJob(ns, div, city, "Management", 0)
  setJob(ns, div, city, "Research & Development", 0)
  setJob(ns, div, city, "Intern", 0)
}
/** @param {NS} ns */
  ...
  for (const div of industries) {
    ...
    for (const city of cities) {
      ...
      if (!indDataDB[hasDivDB[div].industry]) {
        indDataDB[hasDivDB[div].industry] = c.getIndustryData(hasDivDB[div].industry)
      }
...
function getMult(ns, div, city) {
  ...
  for (const scity of cities) {
    ...
    let realestate = Math.pow(0.002 * c.getMaterial(div, scity, "Real Estate").stored + 1, indDataDB[hasDivDB[div].industry].realEstateFactor)
    let hardware = Math.pow(0.002 * c.getMaterial(div, scity, "Hardware").stored + 1, indDataDB[hasDivDB[div].industry].hardwareFactor)
    let robots = Math.pow(0.002 * c.getMaterial(div, scity, "Robots").stored + 1, indDataDB[hasDivDB[div].industry].robotFactor)
    let aicores = Math.pow(0.002 * c.getMaterial(div, scity, "AI Cores").stored + 1, indDataDB[hasDivDB[div].industry].aiCoreFactor);
